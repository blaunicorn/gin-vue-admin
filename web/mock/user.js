...
module.exports = [
    ...
    // checkdb
    {
        ...
        type: 'post',
        response: _ => {
            return { "code": 0, current: 'mock自定义', "data": { "needInit": false }, "msg": "数据库无需初始化1" }
        }
    }
]
